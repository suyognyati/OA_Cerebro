...
<link href="<c:url value='/static/vendors/bootstrap-3.3.6-dist/css/bootstrap.css' />"
	...
	<link href="<c:url value='/collegeadmin/css/vendor.css' />" rel="stylesheet" />
	<link href="<c:url value='/collegeadmin/css/vendor-dashboard-custom.css' />" rel="stylesheet" />
...
<script src="<c:url value='/collegeadmin/js/vendor.js' />"></script>

	<!-- Application Scripts -->
<script src="<c:url value='/static/app/app.js' />"></script>
<script src="<c:url value='/collegeadmin/app/app.js' />"></script>
<script src="<c:url value='/collegeadmin/app/state.js' />"></script>

</head>
<body ng-app="collegeadmin">
	<%! 
		...
		String logoImage = "/Web/collegeadmin/images/c-logo.png";
	%>
												...
												<div class="dropdown-menu"
													...
													<div class="">
														...
														<div class="col-md-8 col-sm-8"
															...
															<label><span>${collegeadmindetail.firstName}</span>&nbsp<span>${collegeadmindetail.lastName}</span></label>
															<br>
