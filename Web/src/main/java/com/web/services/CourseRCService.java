...
public interface CourseRCService {
	...
	void applyForCourse(User vendor, User student, Integer collegeProgramMapId, Integer selectedAllowedQualification, List<University_Subject> selectedSubjectList);
